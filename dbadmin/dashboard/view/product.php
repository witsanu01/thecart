...
session_start();
    $sql_pd = "SELECT * FROM products where id and status_id = 0 ";
...
?>
    ...
    <div class="content">
        ...
        <a class="btn btn-primary " href="recov_product" role="button">กู้คืนสินค้า</a>
        </div>
        ...
        <td style="width:20%"><?php echo $meResult['product_desc']; ?></td>
        ...
        <a class="btn btn-danger"  href="../delete/deleteproduct?user_id=<?php echo $meResult['id']; ?>" role="button">
